...
public class MapAllActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(latlngLandmark1).title("บขส.1").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latlngLandmark1));

        LatLng latLngLandmark2 = new LatLng(16.432643, 102.835542);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark2).title("โรงเรียนขอนแก่นวิทยายน").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark2));

        LatLng latLngLandmark3 = new LatLng(16.433139, 102.836696);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark3).title("บนส.2 ปรับอากาศ").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark3));

        LatLng latLngLandmark4 = new LatLng(16.429768, 102.835821);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark4).title("ไปรษณีย์ขอนแก่น").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark4));

        LatLng latLngLandmark5 = new LatLng(16.427702, 102.835688);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark5).title("โรงเรียนกัลยาณวัตร").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark5));

        LatLng latLngLandmark6 = new LatLng(16.423187, 102.833898);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark6).title("แฟรี่ พลาซ่า").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark6));

        LatLng latLngLandmark7 = new LatLng(16.421009, 102.834317);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark7).title("โรงเรียนเทศบาลสวนสนุก").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark7));

        LatLng latLngLandmark8 = new LatLng(16.412796, 102.831346);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark8).title("โรงเรียนเทศบาลวันกลาง").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark8));

        LatLng latLngLandmark9 = new LatLng(16.412861, 102.828258);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark9).title("สนามกิฬากลาง").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark9));

        LatLng latLngLandmark10 = new LatLng(16.415030, 102.826293);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark10).title("โรงเรียนโสตศึกษา").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark10));

        LatLng latLngLandmark11 = new LatLng(16.415910, 102.823410);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark11).title("โรงเรียนแก่นนครวิทยาลัย").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark11));

        LatLng latLngLandmark12 = new LatLng(16.433089, 102.825491);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark12).title("เซ็นทรัลพลาซ่าขอนแก่น").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark12));

        LatLng latLngLandmark13 = new LatLng(16.431226, 102.823968);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark13).title("สวนเรืองแสง").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark13));

        LatLng latLngLandmark14 = new LatLng(16.436080, 102.830291);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark14).title("คอฟฟี่ เด้อ หล่า : โอโซนวิลเลจ").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark14));

        LatLng latLngLandmark15 = new LatLng(16.408328, 102.834224);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark15).title("วัดหนองแวง / พระมหาธาตุแก่นนคร").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark15));

        LatLng latLngLandmark16 = new LatLng(16.415549, 102.820259);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark16).title("วัดหนองแวง / พระมหาธาตุแก่นนคร").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark16));

        LatLng latLngLandmark17 = new LatLng(16.404426, 102.813128);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark17).title("ประตูน้ำขอนแก่น").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark17));

        LatLng latLngLandmark18 = new LatLng(16.401231, 102.816647);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark18).title("เทสโก้ โลตัส ขอนแก่น").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark18));

        LatLng latLngLandmark19 = new LatLng(16.491685, 102.831488);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark19).title("เทสโก้ โลตัส เอ็กซ์ตร้า").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark19));

        LatLng latLngLandmark20 = new LatLng(16.477894, 102.822860);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark20).title("มหาวิทยาลัยขอนแก่น").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark20));

        LatLng latLngLandmark21 = new LatLng(16.418840, 102.818618);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark21).title("ตลาดต้นตาล").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark21));

        LatLng latLngLandmark22 = new LatLng(16.410074, 102.816836);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark22).title("ตลาดอู้ฟู่").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark22));

        LatLng latLngLandmark23 = new LatLng(16.424943, 102.818906);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark23).title("บิ๊ก ซี ขอนแก่น").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark23));

        LatLng latLngLandmark24 = new LatLng(16.468368, 102.829854);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark24).title("โรงพยาบาลศรีนครินทร์").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark24));

        LatLng latLngLandmark25 = new LatLng(16.427165, 102.834823);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark25).title("ตลาดเทศบาล 1").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark25));

        LatLng latLngLandmark26 = new LatLng(16.428887, 102.835099);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark26).title("ตลาดบางลำพู").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark26));

        LatLng latLngLandmark27 = new LatLng(16.428676, 102.847660);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark27).title("วิทยาลัยเทคนิคขอนแก่น").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark27));

        LatLng latLngLandmark28 = new LatLng(16.428642, 102.863618);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark28).title("มหาวิทยาลัยเทคโนโลยีราชมงคลอีสาน").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        ...
        mMap.addMarker(new MarkerOptions().position(latLngLandmark30).title("โรงพยาบาลราชพฤกษ์").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark30));

        LatLng latLngLandmark31 = new LatLng(16.433224, 102.821034);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark31).title("โรงพยาบาลขอนแก่นราม").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark31));

        LatLng latLngLandmark32 = new LatLng(16.429394, 102.848246);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark32).title("โรงพยาบาลศูนย์ขอนแก่น").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark32));

        LatLng latLngLandmark33 = new LatLng(16.390041, 102.804180);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark33).title("บขส. 3").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark33));

        LatLng latLngLandmark34 = new LatLng(16.405161, 102.814430);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark34).title("แม็คโคร ขอนแก่น").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark34));

        LatLng latLngLandmark35 = new LatLng(16.442495, 102.836309);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark35).title("ศาลากลาง จังหวัดขอนแก่น").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark35));

        LatLng latLngLandmark36 = new LatLng( 16.430006, 102.829495);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark36).title("เทศบาลนครขอนแก่น").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        ...
        mMap.addMarker(new MarkerOptions().position(latLngLandmark38).title("วิทยาลัย อาชีวศึกษา ขอนแก่น").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLngLandmark38));

        LatLng latLngLandmark39 = new LatLng( 16.430244, 102.832277);
        mMap.addMarker(new MarkerOptions().position(latLngLandmark39).title("ตึกคอม ขอนแก่น").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        ...
        mMap.addMarker(new MarkerOptions().position(latLng).title("สาย 2 : บ้านโคกฟันโปง – บ้านโคกน้อย").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLng));

        LatLng latLng1 = new LatLng(16.389369, 102.806185);
        mMap.addMarker(new MarkerOptions().position(latLng1).title("สาย 3 : บขส.3 – บ้านพรหมนิมิตร").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLng1));

        LatLng latLng2 = new LatLng(16.498304, 102.832508);
        mMap.addMarker(new MarkerOptions().position(latLng2).title("สาย 4 : บขส.3 – บ้านหนองน้ำเกลี้ยง").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLng2));

        LatLng latLng3 = new LatLng(16.426291, 102.827488);
        mMap.addMarker(new MarkerOptions().position(latLng3).title("สาย 5 : ตลาดหนองไผ่ล้อม – บ้านทุ่ม").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLng3));

        LatLng latLng5 = new LatLng(16.389369, 102.806185);
        mMap.addMarker(new MarkerOptions().position(latLng5).title("สาย 8 : สามเหลี่ยม – บ้านดอนบม").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLng5));

        LatLng latLng14 = new LatLng(16.455835, 102.827421);
        mMap.addMarker(new MarkerOptions().position(latLng14).title("สาย 9 : สามเหลี่ยม – บ้านสะอาด").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLng14));

        LatLng latLng6 = new LatLng(16.389369, 102.806185);
        mMap.addMarker(new MarkerOptions().position(latLng6).title("สาย 10 : มหาวิทยาลัยขอนแก่น – สนามม้า").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLng6));

        LatLng latLng16 = new LatLng(16.409522, 102.781848);
        mMap.addMarker(new MarkerOptions().position(latLng16).title("สาย 11 : บ้านโนนสวรรค์ – บ้านขามเจริญ").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLng16));

        LatLng latLng8 = new LatLng(16.389369, 102.806185);
        mMap.addMarker(new MarkerOptions().position(latLng8).title("สาย 12 : พิพิธภัณฑ์ – รร.ท่าพระวิทยายน").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLng8));

        LatLng latLng15 = new LatLng(16.447973, 102.822856);
        mMap.addMarker(new MarkerOptions().position(latLng15).title("สาย 13 : บ้านน้อยนิเวศน์ – บ้านสว่างมรรคา").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLng15));

        LatLng latLng17 = new LatLng(16.464537, 102.827373);
        mMap.addMarker(new MarkerOptions().position(latLng17).title("สาย 16 : บ้านโนนทัน – วัดป่าอดุลยาราม").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLng17));

        LatLng latLng18 = new LatLng(16.389369, 102.806185);
        mMap.addMarker(new MarkerOptions().position(latLng18).title("สาย 17 : บ้านโนนทัน – บ้านโคกท่า").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLng18));

        LatLng latLng9 = new LatLng(16.426794, 102.874816);
        mMap.addMarker(new MarkerOptions().position(latLng9).title("สาย 18 : โรงเรียนกัลยาณวัตร – บ้านโนนพอง").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLng9));

        LatLng latLng10 = new LatLng(16.426291, 102.827488);
        mMap.addMarker(new MarkerOptions().position(latLng10).title("สาย 19 : ตลาดหนองไผ่ล้อม – บ้านโนนเรือง").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLng10));

        LatLng latLng11 = new LatLng(16.426291, 102.827488);
        mMap.addMarker(new MarkerOptions().position(latLng11).title("สาย 20 : ตลาดหนองไผ่ล้อม – บ้านกลางฮุง").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLng11));

        LatLng latLng19 = new LatLng(16.455550, 102.855093);
        mMap.addMarker(new MarkerOptions().position(latLng19).title("สาย 21 : บ้านโนนเขวา – บ้านดอนยาง").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLng19));

        LatLng latLng12 = new LatLng(16.414864, 102.874371);
        mMap.addMarker(new MarkerOptions().position(latLng12).title("สาย 22 : บ้านหนองไฮ- บ้านดอนหญ้านาง").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLng12));

        LatLng latLng13 = new LatLng(16.438631, 102.834744);
        mMap.addMarker(new MarkerOptions().position(latLng13).title("สาย 23 : ตลาดเทศบาล 1 – บ้านห้วยเตย").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLng13));

        LatLng latLng4 = new LatLng(16.425585, 102.834150);
        mMap.addMarker(new MarkerOptions().position(latLng4).title("สาย 6 : ตลาดเทศบาล 1 – บ้านเหล่านกชุม").snippet("").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
