...
//        map.moveCamera(CameraUpdateFactory.newLatLng(sydney));
        ...
        switch (txtFix) {
            case "สาย 2 : บ้านโคกฟันโปง – บ้านโคกน้อย":
                ...
                map.addMarker(new MarkerOptions().position(mapCenter1).title("Start").snippet("สาย 2 : บ้านโคกฟันโปง – บ้านโคกน้อย").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN)));
                LatLng mapCenter2 = new LatLng(16.436621, 102.765723);
                map.addMarker(new MarkerOptions().position(mapCenter2).title("Stop").snippet("สาย 2 : บ้านโคกฟันโปง – บ้านโคกน้อย").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_RED)));
